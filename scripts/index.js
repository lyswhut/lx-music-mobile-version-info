...
const run = async() => {
  const versionInfo = await request('https://raw.githubusercontent.com/lyswhut/lx-music-mobile/master/publish/version.json')
  // const versionInfo = await request('https://fastly.jsdelivr.net/gh/lyswhut/lx-music-mobile/publish/version.json')
